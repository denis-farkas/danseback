...
const initCategoryWorkshopRoutes = (app) => {
  ...
  router.post(
    ...
    jwt,
    checkAdmin,
    CategoryWorkshopController.createCategoryWorkshop
  );
  router.get("/read", CategoryWorkshopController.readCategoryWorkshops);
  router.get(
    "/:categoryWorkshopId",
    CategoryWorkshopController.readOneCategoryWorkshop
  );
  router.put(
    "/:categoryWorkshopId",
    jwt,
    checkAdmin,
    CategoryWorkshopController.updateCategoryWorkshop
  );
  router.delete(
    "/:categoryWorkshopId",
    CategoryWorkshopController.deleteOneCategoryWorkshop
  );

  // Utilisation du routeur dans l'application avec le préfixe "/category_workshop"
  app.use("/api/category_workshop", router);
};
